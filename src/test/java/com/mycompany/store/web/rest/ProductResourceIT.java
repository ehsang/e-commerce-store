...
class ProductResourceIT {
    ...
    private static final Size DEFAULT_SIZED = Size.S;
    private static final Size UPDATED_SIZED = Size.M;
    ...
    @Test
    @Transactional
    void checkSizedIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setSized(null);
